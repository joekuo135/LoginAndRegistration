...
NONUM = re.compile(r'^[a-zA-Z]+$')
# Create your models here.

class UserManager(models.Manager):
    def the_validator(self, postData):
        errors= []
        ...
        if 'first_name' in postData:
            ...
            elif not NONUM.match(postData['first_name']):
        ...
        if 'last_name' in postData:
            ...
            elif not NONUM.match(postData['last_name']):
        ...
        if 'birthday' in postData:
            if len(postData['birthday']) == 0:
                ...
                if birth > now:
                    errors.append('You cannot be born in the future. Birthdate must be in the past.')
                elif birth == now:
                    errors.append('No way you have been born today! Do not lie!')
        return errors
